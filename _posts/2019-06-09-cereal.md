...
This is the equation for the model: y = 58.05 + 2.32x<sub></sub>1(fiber) – 1.44x<sub></sub>2(sugars) + 4.65x<sub></sub>3(protein2) + 6.1x<sub></sub>4(protein3) + 11.75x<sub></sub>5(protein4) – 5.77x<sub></sub>6(protein5) + 9.48x<sub></sub>7(protein6)  - 5.15x<sub></sub>8(fat1) – 9.17x<sub></sub>9(fat2) -12.05x<sub></sub>10(fat3) – 23.28x<sub></sub>11(fat5) – 11.6x<sub></sub>12(vitamins25) – 16.41x<sub></sub>13(vitamins100)
