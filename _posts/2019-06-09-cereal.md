...
<p>
* Fiber’s coefficient is 2.3 so this has a small positive impact on rating <br><br>
* Sugar’s coefficient is -1.44 so this has a slightly negative impact on rating <br><br>
* The protein coefficient gets higher as the grams of protein increases (with the exception of protein5 but that one does not pass the t test so we are not including it). So we know a higher protein level has a larger positive impact on rating <br><br>
* The fat coefficient gets higher as the grams of fat increases. So we know a higher fat level has a larger negative impact on rating <br><br>
* The vitamin coefficient gets higher as the % of daily vitamins increase. So, we know a higher vitamin level has a larger negative impact on rating. This one surprised me and I wondered if I made a mistake, so I pulled up the dataset ordered it by highest rating and looked at the vitamin level. Sure enough, there are a lot of ‘0’s for the vitamin level near the top of the list.<br><br>
</p>
<br>
<br>
## Conclusions
