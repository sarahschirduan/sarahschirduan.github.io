...
This is the equation for the model: y = 58.05 + 2.32x<sub>1(fiber) – 1.44x2(sugars) + 4.65x3(protein2) + 6.1x4(protein3) + 11.75x5(protein4) – 5.77x6(protein5) + 9.48x7(protein6)  - 5.15x8(fat1) – 9.17x9(fat2) -12.05x10(fat3) – 23.28x11(fat5) – 11.6x12(vitamins25) – 16.41x13(vitamins100)
