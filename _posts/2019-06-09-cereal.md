...
1.	Some cereal manufacturers are healthier than others
    ...
    3. Nabisco has the lowest fat levels, with American Home Food Products as the next lowest brand.
2.	Grocery stores frequently place the unhealthiest cereals at eye level
    ...
    3. Shelf 2 has the lowest potassium and the lowest fiber. Shelf 3 has the highest potassium levels and the highest fiber amounts. Shelf 1 is in between.
